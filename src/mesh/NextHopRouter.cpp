...
#ifdef EVIL_NODE
                    // Evil node: override hop_limit after normal decrement logic.
                    // HOP_MAX forces 7 (maximum propagation — makes packets travel farther).
                    // HOP_KILL forces 0 (packet dies after this relay — black hole effect).
                    EvilNode::manipulateHopLimit(tosend);
#endif
